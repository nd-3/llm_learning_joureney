...
このリポジトリは、技術理解を深めるための学習リポジトリです。Web・インフラ・データベースなど、特定の言語やフレームワークに限らない基礎概念の学習記録と、複数のポートフォリオ作品を含みます。`03_portfolio/` 配下に、独立した作品を1つずつ追加していく方針です。
...
- `01_basics/`: Git・コマンドライン・Python・SQLなど、言語・分野を問わない基礎学習（`concepts/`は技術理解を深めるための学習ノート置き場）
